...
kony.sdk.claimsRefresh = function(callback, failureCallback) {
    ...
    } else if ((typeof konyRef.claimTokenExpiry === "undefined") || (konyRef.claimTokenExpiry && new Date().getTime() > konyRef.claimTokenExpiry)) {
...
kony.sdk.error.getNullClaimsTokenErrObj = function() {
    ...
    errorObj.code = kony.sdk.errorcodes.cliams_token_null
...
kony.sdk.error.getNullRefreshTokenErrObj = function() {
    var errorObj = {};
    //TODO move error code and constants in to constants.
    errorObj.code = kony.sdk.errorcodes.invalid_session_or_token_expiry
...
kony.sdk.error.getMFcodeErrObj = function(mfcode, message, details, errMessagePrefix) {
    ...
    if (mfcode === "Auth-4") {
        ...
        errorObj.code = kony.sdk.errorcodes.invalid_user_app_services
        errorObj.message = message;
    } else {
        errorObj.code = kony.sdk.errorcodes.default_code
...
kony.sdk.prototype.getMetricsService = function() {
    ...
    if (this.internalSdkObject) {
        metricsServiceObject = this.internalSdkObject.getMetricsService();
    } else {
        if (!this.metricsServiceObject) this.metricsServiceObject = new MetricsService(this);
        metricsServiceObject = this.metricsServiceObject;
    }
    return metricsServiceObject;
};
/**
 * Should not be called by the developer.
 * @class
...
kony.app = (function() {
    var getServiceDocNonMFApp = function(initConfig) {
        ...
        serviceDoc.setAppId();
        serviceDoc.setBaseId();
        serviceDoc.setAppName();
    ...
    var sdkInit = function(initConfig, successcallback, failurecallback) {
        ...
        if (initConfig.isMFApp) {
            ...
            try {
                KNYMobileFabric.initWithServiceDoc(null, null, getServiceDocNonMFApp(initConfig));
                if (kony.license.registerChangeListener) {
                    kony.license.registerChangeListener(KNYMobileFabric.sessionChangeHandler);
                }
                var MetricsService = KNYMobileFabric.getMetricsService();
    ...
    return {
         ...
         */
        setup: function(initConfig, successCallBack, errorCallBack) {
